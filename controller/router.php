...
function router($route) {
	...
	$route_pages = ['about', 'contact', 'customize', 'gift_box', 'index', 'media', 'moonfest', 'newyear', 'partner', 'privacy', 'products', 'single_product', 'soap', 'soapstring', 'trial', 'wedding', 'report', 'business', 'fragrance'];
