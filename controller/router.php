...
function router($route) {
	$route_pages = ['about', 'brand_intro', 'contact', 'customize', 'faq', 'gift_box', 'index', 'media', 'moonfest', 'newyear', 'partner', 'products', 'shopping_guide', 'single_product', 'soap', 'soapstring', 'trial'];
